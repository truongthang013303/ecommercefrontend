...
export const GET_ORDERS_PAGI_REQUEST='GET_ORDERS_PAGI_REQUEST';
export const GET_ORDERS_PAGI_SUCCESS='GET_ORDERS_PAGI_SUCCESS';
export const GET_ORDERS_PAGI_FAILURE='GET_ORDERS_PAGI_FAILURE';
...
export const CALCELED_ORDER_REQUEST='CALCELED_ORDER_REQUEST';
export const CALCELED_ORDER_SUCCESS='CALCELED_ORDER_SUCCESS';
export const CALCELED_ORDER_FAILURE='CALCELED_ORDER_FAILURE';

//Action types for deleteting order
